...
- (id)init {
	...
	if (self = [super init]) {
        ...
        //        db = [[FMDatabase databaseWithPath:[[NSBundle mainBundle] pathForResource:@"taiping" ofType:@"db"]] retain];
		db = [[FMDatabase databaseWithPath:[PathUtilities libraryFilePathWithFileName:TAISHOU_DB]] retain];
